...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		...
		sizes: '256×526',              // (Optional) Size of the favicon, set only if you have favicons of different sizes
		}
	],
};
	...
	links: [
		{
			...
			url: "https://qm.qq.com/q/6IwsVsJdPa",
		},
		{
			name: "Bilibili",
			icon: "fa6-brands:bilibili",
			url: "https://b23.tv/HaSBcro",
		},
		{
			name: "GitHub",
		...
		},
		{
			...
			url: "mailto:fhowo.top@gmail.com",
		},
	],
};
