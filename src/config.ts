...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		credit: {
			...
			text: "小猫Giovanni/明末千里行", // Credit text to be displayed
			url: "https://www.pixiv.net/artworks/133503602", // (Optional) URL link to the original artwork or artist's page
		},
	},
	toc: {
	...
	links: [
		{
			...
			url: "https://qm.qq.com/q/hf8HbNbKJa",
		},
		{
			name: "Bilibili",
			icon: "fa6-brands:bilibili",
			url: "https://b23.tv/ILVHOXQ",
		},
		{
			name: "GitHub",
